...
CREATE TABLE TPP_BI (
   ...
   CONSTRAINT PK_TPP_BI PRIMARY KEY (ID_COMPANY, ID_SPOOL)
)
go
...
CREATE TABLE TPP_DOCUMENT (
   ...
   CONSTRAINT PK_TPP_DOCUMENT PRIMARY KEY (ID_COMPANY, ID_SPOOL)
)
go
...
CREATE TABLE TPP_STAT (
   ...
   CONSTRAINT PK_TPP_STAT PRIMARY KEY (ID_COMPANY, ID_SPOOL)
)
go
...
CREATE TABLE TPP_STATUS (
   ...
   CONSTRAINT PK_TPP_STATUS PRIMARY KEY (ID_COMPANY, ID_SPOOL)
)
go
